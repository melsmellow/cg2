...
export default function CustomizedDialogs({children}) {
  ...
  return (
    <div>
       <BootstrapButton startIcon={<EventBusyIcon />} id="actionBtn3" onClick={handleClickOpen}>
        Discharged Management
      </BootstrapButton>
